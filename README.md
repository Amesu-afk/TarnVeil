...
> TarnVeil пока не опубликован в Google Play и Microsoft Store, поэтому система может предупреждать при ручной установке. Минимум Android 7.0, размер APK ~2,8 МБ.
