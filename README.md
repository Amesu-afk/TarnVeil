...
[![Скачать для Windows](https://img.shields.io/badge/Скачать-для%20Windows-0078d4?style=for-the-badge&logo=windows&logoColor=white)](https://tarnveil.ru/download/tarnveil-setup.exe)
&nbsp;
...
**🪟 Windows** — скачай [установщик](https://tarnveil.ru/download/tarnveil-setup.exe) и запусти его. Если появится SmartScreen — «Подробнее» → «Выполнить в любом случае» (обычное для приложений без подписи издателя).
...
> TarnVeil пока не опубликован в Google Play и Microsoft Store, поэтому система может предупреждать при ручной установке. Минимум Android 7.0, размер APK ~5 МБ.

## 🔐 Безопасность и приватность

- **Личная переписка защищена сквозным шифрованием (E2EE)** — сервер хранит только шифротекст и не может её прочитать. Вложения в личке тоже шифруются на устройстве.
